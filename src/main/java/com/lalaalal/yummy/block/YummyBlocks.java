...
public class YummyBlocks {
    ...
    public static final RegistryObject<Block> AMETHYST_SHARD_BLOCK = register("amethyst_shard_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.AMETHYST_BLOCK)
                    .requiresCorrectToolForDrops().strength(0.5F).sound(SoundType.AMETHYST)));
